...
class EmpAccTableMap extends TableMap
{
    ...
    {
        $this->addRelation('EmpLeave', 'CoreBundle\\Model\\EmpLeave', RelationMap::ONE_TO_MANY, array('id' => 'emp_acc_id', ), null, null, 'EmpLeaves');
        ...
        $this->addRelation('EmpWork', 'CoreBundle\\Model\\EmpWork', RelationMap::ONE_TO_MANY, array('id' => 'emp_acc_acc_id', ), null, null, 'EmpWorks');
    } // buildRelations()
