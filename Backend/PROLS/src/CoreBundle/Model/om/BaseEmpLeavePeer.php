...
abstract class BaseEmpLeavePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Request', 'Status', 'DateStarted', 'DateEnded', 'EmpAccId', 'ListLeaveTypeId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'request', 'status', 'dateStarted', 'dateEnded', 'empAccId', 'listLeaveTypeId', ),
        BasePeer::TYPE_COLNAME => array (EmpLeavePeer::ID, EmpLeavePeer::REQUEST, EmpLeavePeer::STATUS, EmpLeavePeer::DATE_STARTED, EmpLeavePeer::DATE_ENDED, EmpLeavePeer::EMP_ACC_ID, EmpLeavePeer::LIST_LEAVE_TYPE_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'REQUEST', 'STATUS', 'DATE_STARTED', 'DATE_ENDED', 'EMP_ACC_ID', 'LIST_LEAVE_TYPE_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'request', 'status', 'date_started', 'date_ended', 'emp_acc_id', 'list_leave_type_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Request' => 1, 'Status' => 2, 'DateStarted' => 3, 'DateEnded' => 4, 'EmpAccId' => 5, 'ListLeaveTypeId' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'request' => 1, 'status' => 2, 'dateStarted' => 3, 'dateEnded' => 4, 'empAccId' => 5, 'listLeaveTypeId' => 6, ),
        BasePeer::TYPE_COLNAME => array (EmpLeavePeer::ID => 0, EmpLeavePeer::REQUEST => 1, EmpLeavePeer::STATUS => 2, EmpLeavePeer::DATE_STARTED => 3, EmpLeavePeer::DATE_ENDED => 4, EmpLeavePeer::EMP_ACC_ID => 5, EmpLeavePeer::LIST_LEAVE_TYPE_ID => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'REQUEST' => 1, 'STATUS' => 2, 'DATE_STARTED' => 3, 'DATE_ENDED' => 4, 'EMP_ACC_ID' => 5, 'LIST_LEAVE_TYPE_ID' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'request' => 1, 'status' => 2, 'date_started' => 3, 'date_ended' => 4, 'emp_acc_id' => 5, 'list_leave_type_id' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    /**
     * Selects a collection of EmpLeave objects pre-filled with all related objects except EmpAcc.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
