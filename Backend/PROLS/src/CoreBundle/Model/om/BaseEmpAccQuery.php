 ...
 *
 * @method EmpAccQuery leftJoinEmpLeave($relationAlias = null) Adds a LEFT JOIN clause to the query using the EmpLeave relation
 * @method EmpAccQuery rightJoinEmpLeave($relationAlias = null) Adds a RIGHT JOIN clause to the query using the EmpLeave relation
 * @method EmpAccQuery innerJoinEmpLeave($relationAlias = null) Adds a INNER JOIN clause to the query using the EmpLeave relation
 *
 ...
 *
 * @method EmpAccQuery leftJoinEmpWork($relationAlias = null) Adds a LEFT JOIN clause to the query using the EmpWork relation
 * @method EmpAccQuery rightJoinEmpWork($relationAlias = null) Adds a RIGHT JOIN clause to the query using the EmpWork relation
 * @method EmpAccQuery innerJoinEmpWork($relationAlias = null) Adds a INNER JOIN clause to the query using the EmpWork relation
 *
...
abstract class BaseEmpAccQuery extends ModelCriteria
{
    ...
    public function filterByEmpWork($empWork, $comparison = null)
    {
        if ($empWork instanceof EmpWork) {
            return $this
                ->addUsingAlias(EmpAccPeer::ID, $empWork->getEmpAccAccId(), $comparison);
